...
| 2026-08-30 | Direct admission productization and live deployment proof | The Prokura release, protected-service reference backend, deployment recipe, local KDCube route proof, replay/current-authority evidence, and package-publishing automation. |
