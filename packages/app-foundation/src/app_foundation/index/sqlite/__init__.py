...
dependency-free `BruteForceVectorStore` (in `app_foundation.index.vector_store`);
faiss backends live in `kdcube_ai_app.infra.index.faiss`, platform-side, since they carry faiss and numpy — this index *uses* a
