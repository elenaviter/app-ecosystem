...
"""Public connected-account delegation surface.

Importing this package registers the built-in provider adapters.  Individual
symbols are loaded lazily so the aggregate API does not create import cycles
between the broker, operation, and provider modules.
"""
...
_BASE = "connection_hub.delegated_to_kdcube"

# Preserve the package-level registration contract used by Connection Hub.
