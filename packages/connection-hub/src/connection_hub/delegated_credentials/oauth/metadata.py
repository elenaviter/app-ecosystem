...
def protected_resource_metadata(
    ...
    *,
    ...
    if delegated_admission_endpoint:
        # Connection Hub extension: an independently authenticated protected service
        ...
        out["connection_hub_delegated_admission_endpoint"] = str(
            delegated_admission_endpoint
        ).rstrip("/")
        out["connection_hub_delegated_admission_schema"] = "connection_hub.delegated_admission.v1"
        out["connection_hub_delegated_admission_signing_alg_values_supported"] = [
            "hmac-sha256"
        ]
    return out
