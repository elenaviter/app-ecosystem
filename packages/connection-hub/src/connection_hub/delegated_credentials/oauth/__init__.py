...
"""Delegated OAuth protocol, catalog, and storage contracts."""
...
_BASE = "connection_hub.delegated_credentials.oauth"
_EXPORTS = {
    ...
    "oauth_delegated_config_from_connections": f"{_BASE}.config",
