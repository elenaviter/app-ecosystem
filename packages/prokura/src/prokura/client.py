...
"""Transport-neutral typed client for the Prokura connections contract."""
...
class ConnectionsTransport(Protocol):
    """A host transport that executes one named Prokura operation."""

    async def call(self, operation: str, payload: dict[str, Any]) -> Any: ...


class ConnectionsError(RuntimeError):
    """Raised when a Prokura operation returns an error."""
