...
def oauth_delegated_config(
    source: Any | None = None,
    *,
    settings: Any | None = None,
) -> OAuthDelegatedClientConfig:
    """Resolve OAuth delegated-credential config from host-supplied inputs.
    ...
    adapter is disabled.
    A host may supply its settings object for tenant, project, and cookie-name
    defaults. Prokura never reaches into a host's configuration subsystem.
    """
