...
see_also:
  ...
  - https://github.com/kdcube/kdcube/blob/main/app/ai-app/docs/sdk/solutions/connections/authority-providers/credential-envelope-README.md
...
See [Authority Credential Envelope](https://github.com/kdcube/kdcube/blob/main/app/ai-app/docs/sdk/solutions/connections/authority-providers/credential-envelope-README.md).
For the relationship between the delegate and the approving user, see
[Delegation Edges](https://github.com/kdcube/kdcube/blob/main/app/ai-app/docs/sdk/solutions/connections/delegated-credentials/delegation-edges-README.md).
...
```json
{
  "connection_hub_delegated_admission_endpoint": "https://.../public/delegated_admission",
  "connection_hub_delegated_admission_schema": "connection_hub.delegated_admission.v1",
  "connection_hub_delegated_admission_signing_alg_values_supported": ["hmac-sha256"]
}
```
...
[Configure Agent To Service Access](https://github.com/kdcube/kdcube/blob/main/app/ai-app/docs/sdk/solutions/connections/configuring-agent-service-access/configuring-agent-service-access-README.md);
...
[Grant Storage Durability](https://github.com/kdcube/kdcube/blob/main/app/ai-app/docs/sdk/solutions/connections/delegated-connections/design/grant-storage-durability-README.md).
...
diagram lives in
[Delegated Credential Protocol Adapters](https://github.com/kdcube/kdcube/blob/main/app/ai-app/docs/sdk/solutions/connections/delegated-credentials/delegated-credential-protocol-adapters-README.md).
...
therefore does not see it. The request-auth surface accepts it only when the
