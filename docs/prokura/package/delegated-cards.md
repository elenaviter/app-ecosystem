---
id: prokura/package/delegated-cards
...
| --- | --- |
| Capability/resource vocabulary and parser aliases | `prokura.delegated_credentials.oauth.config` |
| Card operations and authority orchestration | `prokura.delegated_credentials.automation_access` |
