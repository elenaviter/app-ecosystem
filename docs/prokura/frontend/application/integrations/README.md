...
canonical KDCube host guides are the
[SDK guide](https://github.com/kdcube/kdcube/blob/main/app/ai-app/docs/sdk/integrations/custom-oauth-oidc-service-README.md)
and the
[task recipe](https://github.com/kdcube/kdcube/blob/main/app/ai-app/docs/recipes/connections/integrations/custom-oauth-oidc-service-README.md).
