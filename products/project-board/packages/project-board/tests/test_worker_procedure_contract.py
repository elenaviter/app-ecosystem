...
def test_every_activation_is_addressed_to_the_approved_commit_and_its_receipt_is_checked():
    ...
    assert "`git -C <deploy-worktree> checkout --detach\n   <sha>` and then `kdcube bundle reload <bundle-id>`" in coordinator
...
def test_an_app_deploys_from_its_deploy_worktree_never_from_a_working_checkout():
    """W202, procedure 2026.09.25.10: since the 2026-09-25 23:23Z window every
