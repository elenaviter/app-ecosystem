...
| Maintain or test the app and local CLI | [App agent rules](repo:applications/playground/domain-solution/apps/problem-board@1-0/AGENTS.md) and [testing](testing.md) |
