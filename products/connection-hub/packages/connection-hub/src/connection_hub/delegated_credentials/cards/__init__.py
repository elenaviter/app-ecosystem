...
_EXPORTS = {
    ...
    "CardHandleMutationResult": f"{_BASE}.handle_metadata",
    "PreparedResidentSecret": f"{_BASE}.handle_metadata",
    "ResidentSecretCleanupAcknowledgement": f"{_BASE}.handle_metadata",
    "ResidentSecretCleanupClaim": f"{_BASE}.handle_metadata",
    "RetiredResidentSecret": f"{_BASE}.handle_metadata",
    "PostgresCardHandleMetadataStore": f"{_BASE}.handle_authority",
    "CardCredentialHandleStore": f"{_BASE}.credential_handles",
    "CardCredentialHandleUnavailable": f"{_BASE}.credential_handles",
    "PostgresCardCredentialHandleStore": f"{_BASE}.credential_handles",
    "RedisCardCredentialHandleStore": f"{_BASE}.credential_handles",
