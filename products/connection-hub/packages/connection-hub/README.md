...
Current release: `2026.09.26.2220`, the first with the `client` extra.
...
structured denials, the client SDK, server-side login
(`connection_hub.server_side_login`: one HttpOnly cookie, sliding renewal, an
OIDC authenticator and a Google Identity Services authenticator), and explicit
...
- [OAuth delegated credential protocol](https://github.com/elenaviter/app-ecosystem/blob/main/docs/connection-hub/package/oauth-delegated-credential-protocol.md)
- [Server-side login](https://github.com/elenaviter/app-ecosystem/blob/main/docs/connection-hub/package/server-side-login.md)
